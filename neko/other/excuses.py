...
def get_excuse():
    """Get a random excuse."""
    return capitalise(random.choice(excuses))
...
excuses = [
        ...
        'I\'m not sure. Try calling the Internet\'s head office -- it\'s in '
        'the book.',
        ...
        'We\'ll fix that in the next (upgrade, update, patch release, service '
        'pack).',
